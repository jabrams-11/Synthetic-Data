...
# Modified color function to generate more vibrant colors
def random_color():
    # Using more saturated colors by setting minimum values higher
...
for image_info in coco_data['images']:
    ...
    for ann in image_annotations:
        ...
        # Random vibrant color for each mask
        mask_color = random_color()

        # Only draw bounding box and label if not a Conductor
        if label != 'Conductor':
