...
images_dir = r"C:\Users\FPL Laptop\Desktop\BlenderSyntheticDataCode\RenderedImages"
json_path = r'RenderedImages\coco_annotations.json'
output_dir = r'RenderedImages\labeled_images_als'
...
CATEGORY_COLORS = {
    'ATS': (0, 255, 0),  # Green in BGR
    'ATS_Anomaly': (0, 0, 255),  # Red in BGR
    'Fuse': (0, 255, 0),  # Green in BGR
    'Fuse_Anomaly': (0, 0, 255),  # Red in BGR
    'ALS': (0, 255, 0),  # Green in BGR
    'ALS_Anomaly': (0, 0, 255)  # Red in BGR
}
...
# Create reverse mapping of category names to IDs
...
for image_info in coco_data['images']:
    ...
    for ann in image_annotations:
        ...
        # Skip if not ALS or ALS_Anomaly
        ...
        # Get the predefined color for this category
        mask_color = CATEGORY_COLORS[category_name]
        ...
        cv2.putText(image, category_name, label_position, cv2.FONT_HERSHEY_SIMPLEX, 1, mask_color, 3)
